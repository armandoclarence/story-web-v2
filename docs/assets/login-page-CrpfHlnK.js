var g=o=>{throw TypeError(o)};var m=(o,t,e)=>t.has(o)||g("Cannot "+e);var i=(o,t,e)=>(m(o,t,"read from private field"),e?e.call(o):t.get(o)),a=(o,t,e)=>t.has(o)?g("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(o):t.set(o,e),l=(o,t,e,n)=>(m(o,t,"write to private field"),n?n.call(o,e):t.set(o,e),e),p=(o,t,e)=>(m(o,t,"access private method"),e);import{A as h,S as f}from"./index-DuSjLy-A.js";var s,r,u;class y{constructor({view:t,model:e,authModel:n}){a(this,s);a(this,r);a(this,u);l(this,s,t),l(this,r,e),l(this,u,n)}async getLogin({email:t,password:e}){i(this,s).showSubmitLoadingButton();try{const n=await i(this,r).getLogin({email:t,password:e});if(!n.ok){console.error("getLogin: response:",n),i(this,s).loginFailed(n.message);return}i(this,u).putAccessToken(n.loginResult.token),i(this,s).loginSuccessfully(n.message)}catch(n){console.error("getLogin: error:",n),i(this,s).loginFailed(n.message)}finally{i(this,s).hideSubmitLoadingButton()}}}s=new WeakMap,r=new WeakMap,u=new WeakMap;var c,d,b;class L{constructor(){a(this,d);a(this,c,null)}async render(){return`
