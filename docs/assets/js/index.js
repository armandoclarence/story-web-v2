...
`;var $,R,Tt,Ct,It;class ct{static async init(t){if(p(this,$,t),!await f(this,R,Tt).call(this))return f(this,R,Ct).call(this),!1;let s=0;const o=5,i=async()=>{if(s>=o){console.log("Failed to find notification container after maximum attempts");return}await f(this,R,It).call(this),document.getElementById("push-notification-container")||(s++,setTimeout(i,1e3))};await i()}static async checkSubscription(){var t;try{const e=await((t=navigator.serviceWorker)==null?void 0:t.ready),s=await(e==null?void 0:e.pushManager.getSubscription());return console.log("Current subscription:",s),s?(localStorage.setItem("pushSubscription",JSON.stringify(s)),!0):(localStorage.removeItem("pushSubscription"),!1)}catch(e){return console.error("Error checking subscription status:",e),!1}}static async requestPermission(){const t=await Notification.requestPermission();return t==="denied"?(console.log("Notifikasi tidak diizinkan"),!1):t==="default"?(console.log("Pengguna menutup kotak dialog permintaan izin"),!1):!0}static async subscribePushMessage(t){var e;console.log("Subscribing to push messages");try{const s=await((e=navigator.serviceWorker)==null?void 0:e.ready),o=await(s==null?void 0:s.pushManager.getSubscription());if(o)return localStorage.setItem("pushSubscription",JSON.stringify(o)),this.updateSubscribeButtonState(t,!0),o;console.log("Creating new push subscription...");const i=await(s==null?void 0:s.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Kt(b.VAPID_PUBLIC_KEY)}));console.log(i);const n=i.toJSON();console.log("Push subscription created:",n),console.log("Sending subscription to server...");const c=await a(this,$).subscribePushNotification({endpoint:n.endpoint,keys:{p256dh:n.keys.p256dh,auth:n.keys.auth}});return console.log("Server response:",c),localStorage.setItem("pushSubscription",JSON.stringify(i)),this.updateSubscribeButtonState(t,!0),console.log("Successfully subscribed to push messages"),i}catch(s){throw console.error("Failed to subscribe:",s),localStorage.removeItem("pushSubscription"),s}}static async unsubscribePushMessage(t){var e;try{const s=await((e=navigator.serviceWorker)==null?void 0:e.ready),o=await(s==null?void 0:s.pushManager.getSubscription());if(o){console.log("Existing subscription found:",o);const i=o.toJSON();await a(this,$).unsubscribePushNotification({endpoint:i.endpoint});const n=await o.unsubscribe();console.log("Unsubscribed from push manager:",n),localStorage.removeItem("pushSubscription"),this.updateSubscribeButtonState(t,!1),console.log("Successfully unsubscribed from push messages")}else console.log("No active subscription found to unsubscribe")}catch(s){throw console.error("Failed to unsubscribe:",s),s}}static async unsubscribePushMessage(t){var e;try{const s=await((e=navigator.serviceWorker)==null?void 0:e.ready),o=await(s==null?void 0:s.pushManager.getSubscription());if(o){console.log("Existing subscription found:",o);const i=o.toJSON();await a(this,$).unsubscribePushNotification({endpoint:i.endpoint});const n=await o.unsubscribe();console.log("Unsubscribed from push manager:",n),localStorage.removeItem("pushSubscription"),this.updateSubscribeButtonState(t,!1),console.log("Successfully unsubscribed from push messages")}else console.log("No active subscription found to unsubscribe")}catch(s){console.error("Failed to unsubscribe:",s)}}static async updateSubscribeButtonState(t,e){if(console.log(t),!!t)if(console.log(e),e){t.innerHTML=gt();const s=t.querySelector("#unsubscribe-button");s&&s.addEventListener("click",async()=>{await this.unsubscribePushMessage(t)})}else{t.innerHTML=tt();const s=t.querySelector("#subscribe-button");s&&s.addEventListener("click",async()=>{await this.requestPermission()&&await this.subscribePushMessage(t)})}}}$=new WeakMap,R=new WeakSet,Tt=async function(){var s;const t=/Android|iPhone|iPad|iPod/i.test(navigator.userAgent),e=/iPhone|iPad|iPod/i.test(navigator.userAgent);if(!("Notification"in window))return console.log("Browser tidak mendukung notifikasi"),!1;if(!("serviceWorker"in navigator))return console.log("Browser tidak mendukung service worker"),!1;if(e)return console.log("Push notifications tidak didukung di iOS"),!1;if(t&&!("PushManager"in window))return console.log("Push notifications tidak didukung di perangkat ini"),!1;try{console.log("Registering service worker...");const o=await((s=navigator.serviceWorker)==null?void 0:s.ready);return console.log("Service Worker ready:",o),console.log("VAPID Key:",b.VAPID_PUBLIC_KEY),!0}catch(o){return console.error("Service Worker not ready:",o),!1}},Ct=function(){const t=document.getElementById("push-notification-container");if(!t)return;t.innerHTML=`
    ...
    `,s=document.createElement("style");s.textContent=e,document.head.appendChild(s)},It=async function(){const t=document.getElementById("push-notification-container");if(console.log("Notification container:",t),!t){console.log("Notification container not found");return}console.log("Setting up notification button"),t.innerHTML="";try{const e=await this.checkSubscription();if(console.log("Is subscribed:",e),e){t.innerHTML=gt();const s=t.querySelector("#unsubscribe-button");s&&s.addEventListener("click",async()=>{try{console.log("Unsubscribe clicked"),await this.unsubscribePushMessage(t)}catch(o){console.error("Error unsubscribing:",o),alert("Gagal berhenti berlangganan. Silakan coba lagi.")}})}else{t.innerHTML=tt();const s=t.querySelector("#subscribe-button");s&&s.addEventListener("click",async()=>{try{console.log("Subscribe clicked"),await this.requestPermission()?await this.subscribePushMessage(t):alert("Mohon izinkan notifikasi untuk mendapatkan pemberitahuan.")}catch(o){console.error("Error subscribing:",o),o.name==="NotAllowedError"?alert("Mohon izinkan notifikasi di pengaturan browser Anda."):alert("Gagal berlangganan. Silakan coba lagi.")}})}}catch(e){console.error("Error setting up notification button:",e),t.innerHTML=tt()}},u(ct,R),u(ct,$,null);var H,J,N,Bt,et;class Se{constructor({content:t,skipLinkButton:e}){u(this,N);u(this,H);u(this,J);p(this,H,t),p(this,J,e),nt.setApp(this),f(this,N,Bt).call(this)}getContent(){return a(this,H)}updateNavigation(){f(this,N,et).call(this)}async initializeApp(){await Z.init(pt),await f(this,N,et).call(this),setInterval(()=>{g.clearOldCache()},60*60*1e3)}}H=new WeakMap,J=new WeakMap,N=new WeakSet,Bt=function(){Yt(a(this,J),a(this,H)),f(this,N,et).call(this),nt.init()},et=async function(){const t=!!L(),e=document.getElementById("navigation-drawer"),s=e==null?void 0:e.children.namedItem("navlist-main"),o=e==null?void 0:e.children.namedItem("navlist");if(!t){s&&(s.innerHTML=""),o&&(o.innerHTML=be());return}s&&o&&(s.innerHTML=ve(),o.innerHTML=we());const i=document.getElementById("logout-button");i&&i.addEventListener("click",n=>{n.preventDefault(),confirm("Apakah Anda yakin ingin keluar?")&&(bt(),location.hash="/login")}),t&&await ct.init(pt)};var B,M,D,O,w,F,v,X,E,Dt,Ot,Ft,dt;const ut=class ut{constructor({video:t,cameraSelect:e,canvas:s,options:o={}}){u(this,E);u(this,B);u(this,M,!1);u(this,D,640);u(this,O,0);u(this,w);u(this,F);u(this,v);u(this,X);p(this,w,t),p(this,F,e),p(this,v,s),f(this,E,Dt).call(this)}static addNewStream(t){if(!Array.isArray(window.currentStreams)){window.currentStreams=[t];return}window.currentStreams=[...window.currentStreams,t]}static stopAllStreams(){if(!Array.isArray(window.currentStreams)){window.currentStreams=[];return}window.currentStreams.forEach(t=>{t.active&&t.getTracks().forEach(e=>e.stop())})}async launch(){p(this,B,await f(this,E,Ft).call(this)),ut.addNewStream(a(this,B)),a(this,w).srcObject=a(this,B),a(this,w).play(),f(this,E,dt).call(this)}stop(){a(this,w)&&(a(this,w).srcObject=null,p(this,M,!1)),a(this,B)instanceof MediaStream&&a(this,B).getTracks().forEach(t=>{t.stop()}),f(this,E,dt).call(this)}async takePicture(){if(!(a(this,D)&&a(this,O)))return null;const t=a(this,v).getContext("2d");return a(this,v).width=a(this,D),a(this,v).height=a(this,O),t.drawImage(a(this,w),0,0,a(this,D),a(this,O)),await new Promise(e=>{a(this,v).toBlob(s=>e(s))})}addCheeseButtonListener(t,e){p(this,X,document.querySelector(t)),a(this,X).onclick=e}};B=new WeakMap,M=new WeakMap,D=new WeakMap,O=new WeakMap,w=new WeakMap,F=new WeakMap,v=new WeakMap,X=new WeakMap,E=new WeakSet,Dt=function(){a(this,w).oncanplay=()=>{a(this,M)||(p(this,O,a(this,w).videoHeight*a(this,D)/a(this,w).videoWidth),a(this,v).setAttribute("width",a(this,D)),a(this,v).setAttribute("height",a(this,O)),p(this,M,!0))},a(this,F).onchange=async()=>{await this.stop(),await this.launch()}},Ot=async function(t){try{if(!(t instanceof MediaStream))return Promise.reject(Error("MediaStream not found!"));const{deviceId:e}=t.getVideoTracks()[0].getSettings(),i=(await navigator.mediaDevices.enumerateDevices()).filter(n=>n.kind==="videoinput").reduce((n,c,l)=>n.concat(`
          <option
            value="${c.deviceId}"
