importScripts("https://storage.googleapis.com/workbox-cdn/releases/7.0.0/workbox-sw.js");workbox.setConfig({debug:!0});const{registerRoute:n,setCatchHandler:g}=workbox.routing,{CacheFirst:a,NetworkFirst:r,StaleWhileRevalidate:h}=workbox.strategies,{precacheAndRoute:d}=workbox.precaching,{ExpirationPlugin:o}=workbox.expiration,{CacheableResponsePlugin:i}=workbox.cacheableResponse,{BackgroundSyncPlugin:f}=workbox.backgroundSync;d([{"revision":null,"url":"assets/css/style.css"},{"revision":null,"url":"assets/js/api-mapper.js"},{"revision":null,"url":"assets/js/favorites-page.js"},{"revision":null,"url":"assets/js/form-templates.js"},{"revision":null,"url":"assets/js/home-page.js"},{"revision":null,"url":"assets/js/login-page.js"},{"revision":null,"url":"assets/js/main.js"},{"revision":null,"url":"assets/js/map.js"},{"revision":null,"url":"assets/js/new-guest-page.js"},{"revision":null,"url":"assets/js/new-page.js"},{"revision":null,"url":"assets/js/not-found-page.js"},{"revision":null,"url":"assets/js/register-page.js"},{"revision":null,"url":"assets/js/story-detail-page.js"},{"revision":null,"url":"assets/js/tiny-slider.js"},{"revision":null,"url":"assets/js/ui-templates.js"},{"revision":"2e1423769784db6e4329bf88f2653f4a","url":"css/offline.css"},{"revision":"d52adcf6b14b9c8de529b9a95dbbf676","url":"css/styles/common.css"},{"revision":"1f36c68756656310292a7993023dfd3a","url":"css/styles/main.css"},{"revision":"e2cccd5984b51e00e2864d005540aba6","url":"css/styles/new-form.css"},{"revision":"5c662b755531d7523065aafe9ecc3954","url":"css/styles/story-detail.css"},{"revision":"8c9635c8cceb026b1d012077244e4f1e","url":"css/styles/story-item.css"},{"revision":"b78aab61c2504aa68734f8ed918460e5","url":"index.html"},{"revision":"fdff27119fda49bcac2e1cad043e89bf","url":"offline.html"},{"revision":"601020486b75a486ca1c8a8f245a818b","url":"favicon.ico"},{"revision":"cc72d67b74d815c4464cbda906464295","url":"icons/android-chrome-192x192.png"},{"revision":"d9522cb7d7717a41b621e54e1c4b498a","url":"icons/android-chrome-512x512.png"},{"revision":"ad07f67ec56aaf0929c1b2c91203e003","url":"icons/apple-touch-icon.png"},{"revision":"04f47bdebf2cd9a3836628b0e509b5bf","url":"icons/book.png"},{"revision":"37f98a2e3c07fcdda6510fade8f1f792","url":"icons/favicon-16x16.png"},{"revision":"9add44bb126590e6c7562bc14a83fb2c","url":"icons/favicon-32x32.png"},{"revision":"8fb1ce30b70f7ce4564e1cd600db4304","url":"icons/heart.png"},{"revision":"f7a08d52b181802ca9db806fd32e8aeb","url":"icons/maskable.png"},{"revision":"dd850966bf340ee8932699a76b6109d4","url":"manifest.webmanifest"}]);n(({request:e})=>e.destination==="image",new a({cacheName:"images",plugins:[new o({maxEntries:60,maxAgeSeconds:30*24*60*60}),new i({statuses:[0,200]})]}));n(({request:e})=>e.destination==="style"||e.destination==="script",new h({cacheName:"static-resources",plugins:[new i({statuses:[0,200]})]}));n(({request:e})=>e.destination==="font",new a({cacheName:"fonts",plugins:[new o({maxEntries:30,maxAgeSeconds:60*60*24*365}),new i({statuses:[0,200]})]}));n(({url:e})=>e.pathname.startsWith("/api/"),new r({cacheName:"api-cache",networkTimeoutSeconds:3,plugins:[new i({statuses:[0,200]}),new o({maxEntries:100,maxAgeSeconds:24*60*60}),new f("apiQueue",{maxRetentionTime:24*60})]}));g(async({request:e})=>e.mode==="navigate"?e.url.includes("/login")||e.url.includes("/register")?new Response(`
        <!DOCTYPE html>
        <html lang="en">
        <head>
          <meta charset="UTF-8">
